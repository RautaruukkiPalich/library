...
public class BookControllerDTO {
    ...
    public static class Response extends BookControllerDTO.Create {
    ...
    public static class ListResponse {
        ...
        @JsonProperty("books")
        private List<BookControllerDTO.Response> books;

        public ListResponse() {
        }

        public ListResponse(List<BookControllerDTO.Response> books) {
            this.books = books;
        }
    }
